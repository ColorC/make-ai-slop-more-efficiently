...
// 团队副本 = D:\P4\main\AIWorkSpace\app\packages\obsidian-md\src\（路径/API 不变，团队工具无感）。
...
const P4 = "D:/P4/main/AIWorkSpace/app/packages/obsidian-md/src";
const FILES = [
  "index.js",
  "renderer.js",
  "index-builder.js",
...
if (diff === 0) {
  ...
  console.log(`\n已回写 ${diff} 个文件到 ${P4}`);
  console.log("下一步（人工确认后执行）: p4 edit/add 对应文件并 submit；提交前过一眼 AIWorkSpace 消费方（wiki-viewer / kb-quiz-game / igame-config）。");
  process.exitCode = 0;
} else {
