...
class Format(BaseModel):
    ...
    例: ["source.git.verified", "domain.example"]"""
    ...
    示例:
      Format(id="oa.automation-context",
             components=["oa.workflow-info", "api.spec", "project.codebase"])
      → Router.run() 中: input_data["api.spec"] 直接访问 API 信息
    """
