...
export default function AgentsSettingsTab({
  ...
  const visibleAgents = useMemo<AgentProvider[]>(() => {
    return ['claude', 'cursor', 'codex', 'gemini', 'kimi', 'opencode', 'omni_agent', 'controller'];
  }, []);
  ...
  const agentContextById = useMemo<Record<AgentProvider, AgentContext>>(() => ({
    ...
    omni_agent: {
      authStatus: providerAuthStatus.omni_agent,
      onLogin: () => onProviderLogin('omni_agent'),
    },
    controller: {
      authStatus: providerAuthStatus.controller,
      onLogin: () => onProviderLogin('controller'),
    },
  }), [
    onProviderLogin,
    ...
    providerAuthStatus.omni_agent,
    providerAuthStatus.controller,
  ]);
