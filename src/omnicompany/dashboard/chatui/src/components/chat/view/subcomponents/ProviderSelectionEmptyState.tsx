...
type ProviderSelectionEmptyStateProps = {
  ...
  setControllerModel: (model: string) => void;
...
export default function ProviderSelectionEmptyState({
  ...
  const setModelForProvider = useCallback(
    (providerId: LLMProvider, modelValue: string) => {
      ...
      } else if (providerId === "controller") {
        setControllerModel(modelValue);
        localStorage.setItem("controller-model", modelValue);
      } else {
        setCursorModel(modelValue);
        localStorage.setItem("cursor-model", modelValue);
      }
    },
    [setClaudeModel, setCursorModel, setCodexModel, setGeminiModel, setKimiModel, setOpenCodeModel, setOmniAgentModel, setControllerModel],
  );
            ...
            {
              {
                ...
                omni_agent: t("providerSelection.readyPrompt.omni_agent", {
                  ...
                  defaultValue: "Ready with Omni Agent {{model}}",
                }),
                controller: t("providerSelection.readyPrompt.controller", {
                  model: controllerModel,
                  defaultValue: "Ready with 总控 (本地 Claude {{model}})",
                }),
              }[provider]
            }
          </p>
