...
const PROVIDER_CAPABILITIES: Record<LLMProvider, ProviderCapabilities> = {
  ...
  // controller (总控) reuses the local Claude SDK runtime verbatim, so it shares
  // Claude's capability profile (interactive permission prompts, images, token
  // usage, the full permission-mode set, abort).
  controller: {
    provider: 'controller',
    permissionModes: ['default', 'auto', 'acceptEdits', 'bypassPermissions', 'plan'],
    defaultPermissionMode: 'default',
