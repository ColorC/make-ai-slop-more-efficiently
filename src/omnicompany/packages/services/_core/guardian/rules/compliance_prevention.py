...
_ORPHAN_MODULE_EXEMPTIONS: tuple[str, ...] = (
    ...
    # 2026-07-15: active patrol chain 首环 (workers/__init__.py 显式聚合,
    # GitDiffScanWorker -> RuleEngineWorker), 同 T11 fs_scanner_worker 性质;
    # rename 行解析修复触碰该文件后进 diff 扫描, 补录免孤儿候选.
    "src/omnicompany/packages/services/_core/guardian/workers/git_diff_scan_worker.py",
...
_WORKER_BASE_NAMES = (
    ...
    # 2026-07-15: ConfigurableAgent 是 AgentNodeLoop 的配置驱动标准外包装
