...
FORMAT_HYGIENE_REQUEST = Format(
    ...
    examples=[{}, {"project_root": "/path/to/your/project"}],
)
            ...
            "files": [
                {
                    ...
                    "abs_path": "/path/to/your/project/src/omnicompany/example.py",
                    "change_type": "M",
                    "content": "...",
                    "omnimark": None,
                }
        ...
        examples=[
            {
                ...
                "scan_root": "/path/to/your/project/src/omnicompany/packages/services",
