    ...
    examples=[
        {
            ...
            "format_obj": {
                ...
                "examples": [{"project_root": "/path/to/project"}],
            },
            "usages": [
                {
    ...
    examples=[
        {
            ...
            "source_file": "src/omnicompany/packages/services/doctor/routers.py",
            "source_root": "src/omnicompany",
        },
    ],
)
    ...
    examples=[
        {
            ...
            "audit_path": "/path/to/project/data/doctor/audit/rtr_FormatExtractorRouter/abc1234.md",
        }
    ],
)
    ...
    examples=[
        {
            ...
            "audit_path": "/path/to/project/data/doctor/audit/rtr_FormatExtractorRouter/a5d1234.md",
