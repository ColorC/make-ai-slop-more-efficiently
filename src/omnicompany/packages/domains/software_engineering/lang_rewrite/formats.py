...
FORMATS = [
    ...
    Format(
        ...
        tags=["structured", "dependency-resolved", "kind.internal"],
    ),
    ...
    Format(
        ...
        parent=f"{DOMAIN}.dependency-graph",
        tags=["structured", "dependency-resolved", "translation-ready", "kind.internal"],
    ...
    Format(
        ...
        tags=["translated", "type-checked", "kind.internal"],
    ...
    Format(
        ...
        tags=["translated", "type-checked", "style-checked", "kind.internal"],
    ...
    Format(
        ...
        tags=["translated", "type-checked", "style-checked", "signature-verified", "kind.internal"],
    ),
    ...
    Format(
        ...
        parent=f"{DOMAIN}.interface-spec",
        tags=["translated", "type-checked", "style-checked", "behavioral-tested", "kind.internal"],
    ),
    ...
    Format(
        ...
        parent=f"{DOMAIN}.checked-code",
        tags=["translated", "type-checked", "semantically-verified", "kind.sink"],
