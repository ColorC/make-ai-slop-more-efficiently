...
FORMATS = [
    ...
    Format(
        ...
        tags=["structured", "executable", "kind.internal"],
    ),
    Format(
        ...
        tags=["structured", "executable", "executed", "kind.internal"],
    ),
    Format(
        ...
        tags=["structured", "executable", "executed", "compared", "kind.internal"],
    ),
    Format(
        ...
        tags=["structured", "executable", "executed", "compared", "diagnosed", "kind.sink"],
    ),
]
