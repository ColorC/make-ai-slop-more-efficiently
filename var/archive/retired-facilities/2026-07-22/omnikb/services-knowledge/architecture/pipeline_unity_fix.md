...
---
omnikb_type: karch
id: kb.arch.pipeline.unity_fix
name: 'Pipeline: unity-fix'
tags:
- layer.pipeline
- topic.pipeline
- pipeline.unity-fix
- domain.unity-qa
maturity: draft
summary: AI 驱动的 Roadmap 修复 — 诊断失败路径、修复 detect 规则、回归验证
scope: omnicompany
code_anchors:
- src/omnicompany/core/pipelines.py:L358-L383
---

# Pipeline: unity-fix

> **已知概要**: AI 驱动的 Roadmap 修复 — 诊断失败路径、修复 detect 规则、回归验证

## Identity

| Field | Value |
|---|---|
| Pipeline name | `unity-fix` |
| Domain tag | `unity-qa` |
