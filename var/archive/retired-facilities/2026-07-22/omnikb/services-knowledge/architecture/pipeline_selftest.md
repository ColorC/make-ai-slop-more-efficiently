...
- domain.selftest
maturity: draft
summary: Omnicompany e2e 功能自测 — 验证管线注册、bindings、EventBus 和 CLI 基础功能
scope: omnicompany
code_anchors:
- src/omnicompany/core/pipelines.py:L516-L541
---

# Pipeline: selftest

> **已知概要**: Omnicompany e2e 功能自测 — 验证管线注册、bindings、EventBus 和 CLI 基础功能

## Identity

| Field | Value |
|---|---|
| Pipeline name | `selftest` |
| Domain tag | `selftest` |
