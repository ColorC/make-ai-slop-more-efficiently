...
---
omnikb_type: karch
id: kb.arch.pipeline.unity_playtest
name: 'Pipeline: unity-playtest'
tags:
- layer.pipeline
- topic.pipeline
...
- domain.unity-qa
maturity: draft
summary: AI 驱动的 Unity 游戏目标导向游玩 — 在指定界面完成具体任务
scope: omnicompany
code_anchors:
- src/omnicompany/core/pipelines.py:L311-L336
---

# Pipeline: unity-playtest

> **已知概要**: AI 驱动的 Unity 游戏目标导向游玩 — 在指定界面完成具体任务

## Identity

| Field | Value |
|---|---|
| Pipeline name | `unity-playtest` |
| Domain tag | `unity-qa` |
