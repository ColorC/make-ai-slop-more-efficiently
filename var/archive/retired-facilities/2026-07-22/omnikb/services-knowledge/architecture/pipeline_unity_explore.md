...
---
omnikb_type: karch
id: kb.arch.pipeline.unity_explore
name: 'Pipeline: unity-explore'
tags:
- layer.pipeline
- topic.pipeline
- pipeline.unity-explore
- domain.unity
maturity: draft
summary: Unity 游戏环境探索管线 — 自动化 UI 交互与观察
scope: omnicompany
code_anchors:
- src/omnicompany/core/pipelines.py:L272-L297
---

# Pipeline: unity-explore

> **已知概要**: Unity 游戏环境探索管线 — 自动化 UI 交互与观察

## Identity

| Field | Value |
|---|---|
| Pipeline name | `unity-explore` |
| Domain tag | `unity` |
