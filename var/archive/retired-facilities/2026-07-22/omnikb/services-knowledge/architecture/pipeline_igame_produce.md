...
---
omnikb_type: karch
id: kb.arch.pipeline.demogame_produce
name: 'Pipeline: demogame-produce'
tags:
- layer.pipeline
- topic.pipeline
- pipeline.demogame-produce
- domain.demogame
maturity: draft
summary: demogame 配表生产管线 — 学习产物 + collab platform排期 → CSV + Lua + P4 changelist
scope: omnicompany
code_anchors:
- src/omnicompany/core/pipelines.py:L172-L197
---

# Pipeline: demogame-produce

> **已知概要**: demogame 配表生产管线 — 学习产物 + collab platform排期 → CSV + Lua + P4 changelist

## Identity

| Field | Value |
|---|---|
| Pipeline name | `demogame-produce` |
| Domain tag | `demogame` |
