...
---
omnikb_type: karch
id: kb.arch.pipeline.sw_tdd
name: 'Pipeline: sw-tdd'
tags:
- layer.pipeline
- topic.pipeline
- pipeline.sw-tdd
- domain.sw_tdd
maturity: draft
summary: TDD 执行 — 写测试 + 跑测试 + 写实现 + 修复回路
scope: omnicompany
code_anchors:
- src/omnicompany/core/pipelines.py:L116-L141
---

# Pipeline: sw-tdd

> **已知概要**: TDD 执行 — 写测试 + 跑测试 + 写实现 + 修复回路

## Identity

| Field | Value |
|---|---|
| Pipeline name | `sw-tdd` |
| Domain tag | `sw_tdd` |
