...
---
omnikb_type: karch
id: kb.arch.pipeline.pipeline_ci
name: 'Pipeline: pipeline-ci'
tags:
- layer.pipeline
- topic.pipeline
...
- domain.pipeline_ci
maturity: draft
summary: 管线质量 CI 扫描 — 批量审计所有域的错误路由完整性和类型安全
scope: omnicompany
code_anchors:
- src/omnicompany/core/pipelines.py:L495-L520
---

# Pipeline: pipeline-ci

> **已知概要**: 管线质量 CI 扫描 — 批量审计所有域的错误路由完整性和类型安全

## Identity

| Field | Value |
|---|---|
| Pipeline name | `pipeline-ci` |
| Domain tag | `pipeline_ci` |
