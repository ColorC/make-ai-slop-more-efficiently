...
---
omnikb_type: karch
id: kb.arch.pipeline.unity_execute
name: 'Pipeline: unity-execute'
tags:
- layer.pipeline
- topic.pipeline
- pipeline.unity-execute
- domain.unity-qa
maturity: draft
summary: Unity 测试执行器 — 执行 TestSuite 并产出 TestReport
scope: omnicompany
code_anchors:
- src/omnicompany/core/pipelines.py:L335-L360
---

# Pipeline: unity-execute

> **已知概要**: Unity 测试执行器 — 执行 TestSuite 并产出 TestReport

## Identity

| Field | Value |
|---|---|
| Pipeline name | `unity-execute` |
| Domain tag | `unity-qa` |
