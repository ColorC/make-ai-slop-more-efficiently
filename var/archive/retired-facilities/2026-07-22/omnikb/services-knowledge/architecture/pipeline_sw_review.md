...
---
omnikb_type: karch
id: kb.arch.pipeline.sw_review
name: 'Pipeline: sw-review'
tags:
- layer.pipeline
- topic.pipeline
- pipeline.sw-review
- domain.sw_review
maturity: draft
summary: 代码审查 — diff 收集 + 上下文探索 + LLM 深度审查
scope: omnicompany
code_anchors:
- src/omnicompany/core/pipelines.py:L77-L102
---

# Pipeline: sw-review

> **已知概要**: 代码审查 — diff 收集 + 上下文探索 + LLM 深度审查

## Identity

| Field | Value |
|---|---|
| Pipeline name | `sw-review` |
| Domain tag | `sw_review` |
